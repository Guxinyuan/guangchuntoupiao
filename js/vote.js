...
/*$(".t1").click(function(){
  ...
  $("#black").height(b+80);*/
    ...
    $(".detail").html("他们是火焰与海水的结合，是热情与安静的连系。在舞台上，他们可以肆意挥洒震荡你的脉搏，也可以抱起吉他为你演唱一首民谣曲。他们可以热情洋溢，也可以温暖如溪。他们会整装待发，一身荣光，勇敢无惧，用他们独特的嗓音带观众走进那遥远的青葱年代。 ")
    $(".l2").html("曹牧之 叶梓靖");
    $(".l1").html("14表演");
